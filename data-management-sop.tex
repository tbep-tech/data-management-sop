...
This version of the book was built automatically with \href{https://github.com/tbep-tech/data-management-sop/actions}{GitHub Actions} on 2025-08-19.
...
Regardless, we're striving to ensure that TBEP's science communication to the public retains a unique voice and visual aesthetic that is \emph{NOT} solely created by generative AI technologies. Likewise, our ethic for developing creative and engaging content shared with the public will first support local voices and partners, rather than immediately utilizing generative AI as the default technology.
