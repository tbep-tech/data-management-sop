...
This version of the book was built automatically with \href{https://github.com/tbep-tech/data-management-sop/actions}{GitHub Actions} on 2026-06-05.
...
\item
  \textbf{Generation of social media content}: Generative AI can be used to create text content in the style appropriate and limitations imposed by certain social media applications. Content can be generated based on the requirement of each social media application, e.g., limiting the output to character length requirements, formatting to an intended audience, or substituting jargon.
\end{enumerate}
