...
For metadata, the same rules apply in the middle of a project as those at the beginning of a project.  First identify where you plan on delivering and hosting your data and work backwards from there.  If the location has a specific metadata standard, identify the metadata information that you'll need to conform to that standard.  If you plan on hosting your data at a more general location, start collecting answers to the "who", "what", "when", "where", and "how" questions for your data.  The most important part of this process is realizing that documenting metadata should start immediately once you realize that you have not been doing so.  The longer you wait, the more likely it is that you'll not be able to track down or you'll simply forget important details about a dataset. 

### I'm at the end of my project

Prepare yourself for damage control if you're at the end of your project and have yet to think about data management.  You have begin the laborious process of extracting intimate details of 

But, have no fear, all is not lost. do not be discouraged at this tage and just realize that something is better than nothing. 
