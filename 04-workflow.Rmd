...
1. __Generation of social media content__: Generative AI can be used to create text content in the style appropriate and limitations imposed by certain social media applications. Content can be generated based on the requirement of each social media application, e.g., limiting the output to character length requirements, formatting to an intended audience, or substituting jargon. 
