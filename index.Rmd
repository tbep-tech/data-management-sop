...
author: "Marcus W. Beck, Gary E. Raulerson"
date: "`r Sys.Date()`"
...
Using an open science ethos, we strongly encourage community collaboration in how this document evolves. This means anybody can contribute directly to content in this document.  Please follow the guidelines in section \@ref(contrib) to learn how to contribute and improve this SOP. 
...
<a rel='license' href='http://creativecommons.org/licenses/by/4.0/'><img alt='Creative Commons License' style='border-width:0' src='https://i.creativecommons.org/l/by/4.0/88x31.png' /></a>&nbsp;&nbsp;This book is licensed under a <a rel='license' href='http://creativecommons.org/licenses/by/4.0/'>Creative Commons Attribution 4.0 International License</a>.
 ...
 This version of the book was built automatically with [GitHub Actions](https://github.com/tbep-tech/data-management-sop/actions) on `r Sys.Date()`.
