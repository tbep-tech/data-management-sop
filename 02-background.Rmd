...
```{r michener, echo = F, fig.cap = 'Loss of information over time in the absence of data management <span class="citation">(Michener et al. <a href="#ref-Michener97" role="doc-biblioref">1997</a>)</span>.'}
